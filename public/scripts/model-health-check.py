...
CONFIG_FILE = '/home/openclaw/.openclaw/workspace/config/model-pools.json'
LOG_FILE = '/home/openclaw/.openclaw/workspace/logs/model-health.log'
STATUS_FILE = '/home/openclaw/.openclaw/workspace/data/model-health-status.json'
